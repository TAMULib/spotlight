  ...
  class PagesController < Spotlight::ApplicationController
    ...
    def attach_breadcrumbs
      if view_context.current_page? '/'
        add_breadcrumb t(:'spotlight.curation.nav.home', title: current_exhibit.title), "http://library.tamu.edu/research/digital_collections"
        ...
        add_breadcrumb t(:'spotlight.exhibits.breadcrumb', title: current_exhibit.title), "http://library.tamu.edu/research/digital_collections"
        add_breadcrumb current_exhibit.title, spotlight.exhibit_root_path(current_exhibit)
      end
    end
